...
public class ControlActionMetaData {
  ...
  private ControlActionStatus actionStatus;
  ...
  public synchronized boolean getActiveContainerStopped() {
    return activeContainerStopped;
  }

  public synchronized ControlActionStatus getActionStatus() {
    return actionStatus;
  }

  public synchronized void setActionStatus(ControlActionStatus.StatusCode statusCode) {
    this.actionStatus.status = statusCode;
  }

  public synchronized void setActionStatus(ControlActionStatus.StatusCode statusCode, String responseMessage) {
    this.actionStatus.status = statusCode;
  ...
  public String toString() {
    return "ControlActionMetaData{" + "processorId='" + processorId + '\'' + ", sourceHost='" + sourceHost + '\''
        + ", destinationHost='" + destinationHost + '\'' + ", actionStatus=" + actionStatus + '}';
  }
}